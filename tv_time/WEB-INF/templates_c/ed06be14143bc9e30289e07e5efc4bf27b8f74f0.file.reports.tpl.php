<?php /* Smarty version Smarty-3.0.7, created on 2017-11-08 09:35:48
         compiled from "/var/www/html/tv_time/WEB-INF/templates/reports.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3654132295a02cff4c67b52-76491833%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ed06be14143bc9e30289e07e5efc4bf27b8f74f0' => 
    array (
      0 => '/var/www/html/tv_time/WEB-INF/templates/reports.tpl',
      1 => 1508950116,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3654132295a02cff4c67b52-76491833',
  'function' => 
  array (
  ),
...
<?php if ((($_smarty_tpl->getVariable('user')->value->isPluginEnabled('cl')&&!($_smarty_tpl->getVariable('user')->value->isClient()&&$_smarty_tpl->getVariable('user')->value->client_id))||($_smarty_tpl->getVariable('custom_fields')->value&&$_smarty_tpl->getVariable('custom_fields')->value->fields[0]&&$_smarty_tpl->getVariable('custom_fields')->value->fields[0]['type']==CustomFields::TYPE_DROPDOWN))){?>
        <tr>
  <?php if ($_smarty_tpl->getVariable('user')->value->isPluginEnabled('cl')&&!($_smarty_tpl->getVariable('user')->value->isClient()&&$_smarty_tpl->getVariable('user')->value->client_id)){?><td><b><?php echo $_smarty_tpl->getVariable('i18n')->value['label']['client'];?>
...
<?php if ($_smarty_tpl->getVariable('user')->value->isPluginEnabled('cl')||$_smarty_tpl->getVariable('user')->value->isPluginEnabled('iv')){?>
              <tr>
...
<?php if (((($_smarty_tpl->getVariable('user')->value->canManageTeam()||$_smarty_tpl->getVariable('user')->value->isClient())||$_smarty_tpl->getVariable('user')->value->isPluginEnabled('ex'))&&defined('COST_ON_REPORTS')&&isTrue(@COST_ON_REPORTS))){?>
