...
; renamed to configuration.php (without the sufix '-dist') and the parameters
...
; UNIX
uploadPath = "/var/www/html/proyectos/data/upload/"
; WINDOWS
;uploadPath = "C:\phprojekt_private\upload\"

; Path where will be placed temporaly files.
; UNIX
tmpPath = "/var/www/html/proyectos/data/upload/"
; WINDOWS
;tmpPath = "C:\phprojekt_private\upload\"

; Path where will be placed modules created by the admin.
; UNIX
applicationPath = "/var/www/html/proyectos/data/application/"
; WINDOWS
;applicationPath = "C:\phprojekt_private\application\"

; Path where webdav resides
; UNIX
webdavPath = "/var/www/html/proyectos/data/webdav/"
; WINDOWS
;webdavPath = "C:\phprojekt_private\webdav\"
...
database.params.host = 172.17.0.3
...
; UNIX
log.debug.filename = "/var/www/html/proyectos/logs/debug.log"
; WINDOWS
...
; UNIX
log.err.filename = "/var/www/html/proyectos/logs/err.log"
; WINDOWS
...
uploadPath = "C:\Programme\Zend\Apache2\phprojekt_private\upload\"
tmpPath    = "C:\Programme\Zend\Apache2\phprojekt_private\tmp\"
...
log.debug.filename = "C:\Programme\Zend\Apache2\phprojekt_private\logs\debug.log"
log.err.filename   = "C:\Programme\Zend\Apache2\phprojekt_private\logs\err.log"
...
; authentication.ldap.server1.username               = "CN=admin,dc=domain,dc=com"
; authentication.ldap.server1.password               = secret
...
; Set this if you need a specific account Filter format
;authentication.ldap.server1.accountFilterFormat
